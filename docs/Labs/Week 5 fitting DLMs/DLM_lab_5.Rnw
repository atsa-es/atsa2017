...
\begin{figure}[htp]
\begin{center}
<<plotdata, eval=TRUE, echo=FALSE, fig=TRUE, height=4, width=6>>=
...
\begin{figure}[htp]
\begin{center}
<<plotdlm1, eval=TRUE, echo=FALSE, fig=TRUE, height=4, width=6>>=
...
\begin{figure}[htp]
\begin{center}
<<plotdlmForeLogit, eval=TRUE, echo=FALSE, fig=TRUE, height=3, width=6>>=
...
\begin{figure}[htp]
\begin{center}
<<plotdlmForeRaw, eval=TRUE, echo=FALSE, fig=TRUE, height=3, width=6>>=
...
\begin{figure}[htp]
\begin{center}
<<plotdlmQQ, eval=TRUE, echo=FALSE, fig=TRUE, height=2, width=4>>=
...
\begin{figure}[htp]
\begin{center}
<<plotdlmACF, eval=TRUE, echo=FALSE, fig=TRUE, height=2, width=4>>=
## use layout to get nicer plots
layout(matrix(c(0,1,1,1,0),1,5,byrow=TRUE))
