...
## ----plot_phytos, fig.height=9, fig.width=8------------------------------
...
## ----plot_dfa_1, fig.height=9, fig.width=8, eval=TRUE--------------------
ylbl <- phytoplankton
w_ts <- seq(dim(dat)[2])
...
## ----plot_dfa_fits, fig.height=9, fig.width=8, eval=TRUE-----------------
## get model fits & CI's
...
## ----fit_DFA_covars, cache=TRUE------------------------------------------
mod_list=list(m=3, R="diagonal and unequal")
dfa_temp <- MARSS(dat_1980, model=mod_list, form="dfa", z.score=TRUE,
                  control=con_list, covariates=temp)
dfa_TP <- MARSS(dat_1980, model=mod_list, form="dfa", z.score=TRUE,
                control=con_list, covariates=TP)
dfa_both <- MARSS(dat_1980, model=mod_list, form="dfa", z.score=TRUE,
...
## ----plot_dfa_temp_fits, fig.height=9, fig.width=8, eval=TRUE------------
## get model fits & CI's
